...
typedef struct 
{
	...
	uint8_t I2C_TWAR ;
	uint8_t I2C_TWDR ;
	uint8_t Reserved[0x32];				/* NOT Accessible  */
	uint8_t I2C_TWCR ;
}I2CTypeDef_t;
...
*/ 
I2C_STATUS HAL_I2C_Mem_Write(I2C_Handler_t * Handler ,uint8_t DeviceAdd,uint16_t MemAdd ,uint8_t MemAddSize ,uint8_t * pTxData ,uint8_t DataSize );
 ...
 * param. @ : DataSize number of bytes that you need to read 
*/ 
I2C_STATUS HAL_I2C_Mem_Read(I2C_Handler_t * Handler ,uint8_t DeviceAdd,uint16_t MemAdd ,uint8_t MemAddSize ,uint8_t * pRxData ,uint8_t DataSize );
