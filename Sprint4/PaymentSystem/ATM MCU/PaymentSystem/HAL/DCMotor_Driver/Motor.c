...
static MotorSelect_t MOTORS ={	.Motor[MOTOR_1].Pin[MOTOR__H] = GPIO_PIN_2 , .Motor[MOTOR_1].Port[MOTOR__H] = GPIOB ,
								.Motor[MOTOR_1].Pin[MOTOR__L] = GPIO_PIN_3 , .Motor[MOTOR_1].Port[MOTOR__L] = GPIOB ,
								.Motor[MOTOR_2].Pin[MOTOR__H] = GPIO_PIN_0 , .Motor[MOTOR_2].Port[MOTOR__H] = GPIOB ,
								.Motor[MOTOR_2].Pin[MOTOR__L] = GPIO_PIN_1 , .Motor[MOTOR_2].Port[MOTOR__L] = GPIOB ,
							 } ;
