  ...
  TIM_Status_t TIM_NormalModeInit(TIMInit_t * TIMConfig )
{
	...
	TCNT1 = 65535 - TIMConfig->COMPConfig.TIM16Bit.CompValue ;
	return TIM_OK ;
...
{
	if(COMPMatch0_Fun != NULL)
	COMPMatch0_Fun();
}
void __vector_11(void)
{
	if(OverFlow0_Fun != NULL)
	OverFlow0_Fun();
}
...
{
	if(COMPMatch2_Fun != NULL)
	COMPMatch2_Fun();
}
void __vector_5(void)
{
	if(OverFlow2_Fun != NULL)
	OverFlow2_Fun();
}
